...
|Steps                                                                                                                          |  
|:------------------------------------------------------------------------------------------------------------------------------|
|1.Run the python file it will prompt for input Jira_url,Username,PAT_Token,Excel_File_Path                                       |
|2.After providing the values click 'OK'. New popup will open with successfull message like Attachment uploaded for all issues. |
